...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Contacts', path: '/contacts', entity: 'contact', service: AccessServiceEnum.PROJECT, icon: FiPhoneCall },
    { name: 'Messages', path: '/messages', entity: 'message', service: AccessServiceEnum.PROJECT, icon: FiMail },
    { name: 'Tasks', path: '/tasks', entity: 'task', service: AccessServiceEnum.PROJECT, icon: FiClock },
