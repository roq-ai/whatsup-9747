...
export function BusinessListPage(props: BusinessListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getBusinesses({
        relations: ['user', 'contact.count', 'task.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('contact', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'contact',
          header: 'Contact',
          accessorKey: 'contact',
          cell: ({ row: { original: record } }: any) => record?._count?.contact,
        }
      : null,
